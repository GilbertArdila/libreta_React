...
const regex_apellido = new RegExp(/^[ÁÉÍÓÚA-Z]?[a-záéíóú]{3,}?[\s]?([ÁÉÍÓÚA-Z]?[a-záéíóú]+)*$/) ;

//regext recomendado por la w3c
const regex_mail=new RegExp(/^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/)

//validamos solamente numeros, le damos una longitud de 10 dígitos
const regex_phone=new RegExp(/^[0-9](\d{9})(?!.*[ +/_=-])$/)

export {regex_name,regex_mail,regex_phone,regex_apellido}